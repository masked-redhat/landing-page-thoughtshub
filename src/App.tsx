...
function App() {
  ...
  return (
    <div className="md:w-full md:h-[calc(100vh-0.75rem*2)] w-screen h-screen md:rounded-2xl bg-black text-white transition-all font-space-grotesk overflow-hidden mx-auto max-w-[1440px!important]">
      ...
      <main className="md:h-[calc(100vh-1.9rem*2)] h-[calc(100vh-2.3rem)] w-full transition-all overflow-hidden bg-gradient-to-bl from-black via-black/25 via-55% to-purple-800/75 relative text-gray-100">
        <div className="">
          <img
            src={
              pathname === "/"
